...
export default function Header() {
  return (
    <header className="bg-surface/85 sticky top-0 z-40 border-b border-outline-variant backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-container-max items-center justify-between px-[20px] md:px-lg">
        ...
        <Link href="/" className="group flex items-end leading-none">
          ...
          <span className="mb-[1px] ml-[2px] h-[4px] w-[4px] rounded-full bg-accent" />
        </Link>
