...
- **디에디트 스타일 큐레이션** — `featured: true` 아티클을 매거진 표지처럼 배치한 Hero 섹션
- **읽기 경험 최적화** — 본문 최대 너비 700px, 읽기 진행률 바, 이전/다음 글 내비게이션
- **뉴스레터 구독** — 메인 Sticky 박스, 본문 30% 지점 및 최하단 폼 (Resend 연동 지원)
