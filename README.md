...
```
├── app/
│   ├── (site)/                   # 공개 사이트 (공통 Header/Footer 레이아웃)
│   │   ├── page.tsx              # 홈 (인트로 + 필터 + 피처드 + 그리드)
│   │   ├── insight/[slug]/page.tsx  # 아티클 상세 (SEO 메타 + JSON-LD)
│   │   ├── briefs/page.tsx       # 단신 전체 (페이지네이션)
│   │   └── about/page.tsx
│   ├── studio/                   # 내장 CMS (로그인/대시보드/에디터)
│   ├── api/admin/                # 스튜디오 백엔드 (인증·발행·업로드)
│   ├── layout.tsx
│   └── sitemap.ts / robots.ts
├── components/
│   ├── layout/    # Header, Footer, ThemeToggle
│   ├── insight/   # HomeFeed, ReadingProgress
│   ├── briefs/    # BriefItem
│   ├── studio/    # LoginForm, Dashboard, Editor
